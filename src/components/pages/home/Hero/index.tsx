  ...
  return (
    <section id="Hero" className="Hero">
      <div className="max-w-[57.6rem]">
        ...
        <p className="pt-6 text-xl">+4 años de experiencia. <span className="font-semibold featured">Frontend Developer e Ingeniero en Información</span> de Carabobo, Venezuela. Especializado en el desarrollo de aplicaciones web únicas.</p>
        <div className="mt-8 flex gap-4">
          <a href="mailto:orlando.developer17@gmail.com" className="Button">
